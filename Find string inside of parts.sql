...
BEGIN
	...
	--SELECT @PdefName [@PdefName], @ContentView [ContentView]

	--	check content view for search string, bail out if it doesn't exist
	IF (CHARINDEX(@Search_STR, @ContentView, 1) = 0 )
	CONTINUE
